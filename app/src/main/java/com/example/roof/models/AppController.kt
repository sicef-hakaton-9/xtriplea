...
public class AppControllerTest {
    ...
    companion object{
        public fun test(context: Context)
        {
            ...
            app.addBuilding(Building("Bulevar 12. feb 124B", 43.344453,21.868461,4,200.0,1974,1.0,15.0))
            app.addBuilding(Building("G.M. Lešjanina 41", 43.319522,21.890812,7,250.0,1980,2.0,15.0))
            app.addBuilding(Building("Branka Krsmanovića 43", 43.323394,21.920225,6,220.0,1985,2.0,15.0))
            app.addBuilding(Building("Jug Bogdanova 25", 43.314777,21.891676,4,190.0,1989,3.0,15.0))
